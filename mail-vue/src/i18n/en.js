const en = {
    ...
    attSize: 'Size',
    attType: 'Type',
    attTypeAtt: 'Attachment',
    attTypeEmbed: 'Embedded',
    attUser: 'User',
    attUserRole: 'Role',
    attEmailSubject: 'Subject',
    attTime: 'Time',
    attClearTime: 'Auto Clear',
    attUsageTitle: 'Attachment Usage',
    attDeleteUserConfirm: 'Delete {user}\'s copy of this file?',
    attOpHint1: 'Expand a file row to operate on a single user: locate / delete / restore',
    attOpHint2: 'Actions in the main table apply to all references of the file',
    attSelectFirst: 'Please select attachments first',
    attSelectFileFirst: 'Please select a file row (main table) first',
    attUsageFiles: 'Files',
    attUsageSize: 'Size',
    attCosFiles: 'COS Objects',
    attCosSize: 'COS Usage',
    attQuotaUsed: 'Used',
    attQuotaTotal: 'Total',
    attQuotaRemain: 'Remain',
    attS3Expire: 'S3 Expire',
    attPreview: 'Preview',
    attDownload: 'Download',
    attDelete: 'Delete',
    attDeleteConfirm: 'Delete this attachment? The related email will also be deleted and moved to trash.',
    attDeleteBatchConfirm: 'Delete {count} selected attachments? Their related emails will also be deleted and moved to trash.',
    attDeleteToTrash: 'Moved to trash',
    attTrashDelete: 'Delete Permanently',
    attTrashConfirm: 'Permanently delete this attachment? It cannot be recovered.',
    attTrashBatchConfirm: 'Permanently delete {count} selected attachments? They cannot be recovered.',
    attLocate: 'Locate Email',
    attLocateFail: 'Cannot locate email',
    attRestore: 'Restore',
    attRestoreSuccess: 'Restored',
    ...
    // ---- Mailvelope / OpenPGP ----
    pgpMailTag: 'PGP Mail',
    pgpEncryptedMail: 'Encrypted content readable only by recipients',
    pgpSignedMail: 'Signed content, signature can be verified',
    pgpDetected: 'OpenPGP content detected',
    pgpAttMail: 'PGP armored attachment',
    pgpDecryptBtn: 'Decrypt / Verify with Mailvelope',
    pgpBackRaw: 'Show raw content',
    pgpNoExtTitle: 'Mailvelope extension required',
    pgpNoExtDesc: 'Decrypting and sending encrypted email requires the Mailvelope browser extension. Keys stay in your own browser; the mail server can never read them.',
    pgpInstallChrome: 'Install for Chrome',
    pgpInstallFirefox: 'Install for Firefox',
    pgpAuthorizeBtn: 'Authorize this site for Mailvelope',
    pgpAuthorizeHint: 'Already installed? Allow this site inside Mailvelope and retry.',
    pgpDisconnected: 'Mailvelope is being updated. Please reload the page and retry',
    pgpDecrypting: 'Decrypting via Mailvelope…',
    pgpFailedTitle: 'Decryption / verification failed',
    pgpRetry: 'Retry',
    pgpPubKeyFound: 'This mail contains an OpenPGP public key',
    pgpPubKeyDesc: 'Import it to send encrypted mail to this contact or verify their signatures.',
    pgpImportKey: 'Import public key into keyring',
    pgpImportDone: 'Public key imported',
    pgpImportExist: 'This public key already exists',
    pgpKeyManager: 'Key management',
    pgpGotIt: 'Got it',
    pgpEnter: 'Enable PGP encrypted editing (Mailvelope)',
    pgpExit: 'Exit PGP mode',
    pgpEditingMode: 'Mailvelope encrypted editing: content is encrypted only when sent',
    pgpNoAttachment: 'PGP mode does not support regular attachments. Exit encrypted mode to add them',
    pgpReplyHint: 'The original mail is PGP encrypted; the reply will use encrypted mode and ciphertext is never stored in plain',
    pgpExitConfirm: 'Exiting PGP mode will discard the content in the Mailvelope editor. Continue?',
    pgpEncrypting: 'Encrypting…',
    pgpLoading: 'Mailvelope editor is not ready yet, please wait',
    pgpUnavailableTitle: 'Mailvelope extension not detected',
    pgpUnavailableDesc: 'Sending PGP encrypted mail requires the Mailvelope browser extension plus key generation and site authorization.',
    pgpErrExt: 'Mailvelope extension unavailable',
    pgpErrAccount: 'Sender address is not set, PGP unavailable',
    pgpErrKeyring: 'Keyring unavailable',
    pgpErrNoKey: 'No usable key found (import the recipient public key / this mailbox private key first)',
    pgpErrDecrypt: 'Decryption failed',
    pgpErrParse: 'No valid PGP armored block found',
    pgpErrCancel: 'Operation cancelled',
    pgpErrAuthorize: 'This site is not authorized for Mailvelope yet',
    pgpErrType: 'This PGP content type is not supported inline',
    pgpErrOpts: 'Invalid PGP editor options',
    pgpErrGeneric: 'PGP operation failed',
}
